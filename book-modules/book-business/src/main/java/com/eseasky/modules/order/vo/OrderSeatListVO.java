...
@Alias("OrderSeatListVO")
@ApiModel(value="预约订单（座位）", description="预约订单（座位）")
public class OrderSeatListVO extends Model<OrderSeatListVO> {
    ...
    @ApiModelProperty(value = "自动续约时间阈值（长租，单位：h）")
    ...
    private Integer isApproveRequire;
