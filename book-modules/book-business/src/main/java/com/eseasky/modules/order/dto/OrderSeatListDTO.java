...
import com.eseasky.modules.order.vo.response.StaLongDetailRepVO;
...
public class OrderSeatListDTO {
    ...
    @ApiModelProperty(value = "预约类型（1.短租 2.长租）")
