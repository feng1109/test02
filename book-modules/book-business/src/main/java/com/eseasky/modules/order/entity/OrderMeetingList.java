...
@ApiModel(value="OrderMeetingList对象", description="会议室预约订单")
public class OrderMeetingList extends Model<OrderMeetingList> {

    private static final long serialVersionUID = 2363437357892078309L;

    @ApiModelProperty(value = "id")
    private String orderMeetingId;

    @ApiModelProperty(value = "关联的最新的会议室记录id")
    ...
    @ApiModelProperty(value = "订单类型 （1.短租 2.长租）")
